// This file is used to store the previous version of page.tsx before the visual uplift changes.
// To revert, simply copy this file's contents back to src/app/page.tsx.

/* --- BEGIN ORIGINAL page.tsx --- */
'use client'
